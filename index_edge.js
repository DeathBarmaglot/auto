...
//images folder
var im='https://raw.githubusercontent.com/DeathBarmaglot/auto/master/images/';
...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                align: "center",
                font: ['Arial, Helvetica, sans-serif', 14, "rgba(0,27,144,1.00)", "normal", "none", ""]
            },
            {
                id: 'TextCopy4',
                type: 'text',
            ...
            },
            {
                ...
                align: "left",
                font: ['\'Arial Black\', Gadget, sans-serif', 21, "rgba(255,0,0,1.00)", "400", "none", "normal"]
            },
            {
                id: 'Text3',
                type: 'text',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid229", tween: [ "style", "${_TextCopy}", "left", '213px', { fromValue: '475px'}], position: 5870, duration: 620, easing: "easeOutCubic" },
                { id: "eid230", tween: [ "style", "${_TextCopy}", "left", '475px', { fromValue: '213px'}], position: 10124, duration: 620, easing: "easeOutCubic" },
                ...
                { id: "eid219", tween: [ "style", "${_Text2Copy}", "left", '255px', { fromValue: '447px'}], position: 1306, duration: 620, easing: "easeOutCubic" },
                { id: "eid238", tween: [ "style", "${_Text2Copy}", "left", '447px', { fromValue: '255px'}], position: 10124, duration: 620, easing: "easeOutCubic" },
